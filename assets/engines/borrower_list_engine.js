    ...
    function handleFilledExcelUpload(e) {
        ...
        reader.onload = function(evt) {
            ...
            excelData.forEach(row => {
                const textCols = ['পোস্ট', 'থানা/উপজেলা', 'উপজেলা', 'থানা', 'জেলা', 'গ্রাম', 'বাড়ি', 'বাড়ি', 'ইউনিয়ন', 'ইউনিয়ন', 'ইউ/পৌর', 'পৌরসভা', 'বাড়ি ও গ্রাম', 'নাম', 'পিতা/স্বামীর নাম', 'পিতার/স্বামীর নাম', 'পিতার নাম', 'স্বামীর নাম', 'পিতা', 'স্বামী', 'নাম ও পিতার নাম', 'মোবাইল', 'মোবাইল নম্বর', 'মন্তব্য', 'স্ট্যাটাস', 'ঋণের স্ট্যাটাস', 'প্রতিষ্ঠান', 'ঋণের ধরণ', 'হিসাব নম্বর', 'ঋণের খাত', 'ঋণের খাত', 'শ্রেণীমান'];
                textCols.forEach(col => {
                    if (row[col] === 0 || row[col] === '0') row[col] = '';
                });
                ...
                if (newItem['বিতরণের পরিমাণ'] && !newItem['ঋণের পরিমাণ']) {
                    newItem['ঋণের পরিমাণ'] = newItem['বিতরণের পরিমাণ'];
                }
                if (newItem['বিতরণের পরিমান'] && !newItem['ঋণের পরিমাণ']) {
                    newItem['ঋণের পরিমাণ'] = newItem['বিতরণের পরিমান'];
                }
    ...
    window.generateLegalReport = function() {
        ...
        function buildPrintRow(item, seqNum) {
            ...
            tr.innerHTML = `<td class="no-print" style="text-align:center;"><input type="checkbox" class="loan-checkbox" value="${item._id}"></td>
                ...
                <td style="text-align:center;">${item['\u09b8\u09cd\u099f\u09cd\u09af\u09be\u099f\u09be\u09b8']||''}</td>
                <td style="text-align:center;">${toBanglaNumbers(item['\u09ae\u09cb\u09ac\u09be\u0987\u09b2 \u09a8\u09ae\u09cd\u09ac\u09b0']||item['\u09ae\u09cb\u09ac\u09be\u0987\u09b2']||'')}</td>
                <td>${item['\u09ae\u09a8\u09cd\u09a4\u09ac\u09cd\u09af']||''}</td>`;
            return tr;
        }
    ...
    function exportToExcel() {
        ...
        const exportData = filtered.map((item, index) => {
            ...
            return {
                ...
                "মোবাইল নম্বর": item['মোবাইল নম্বর'] || item['মোবাইল'] || '',
